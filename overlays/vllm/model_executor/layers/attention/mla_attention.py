    ...
    def forward_impl(
        ...
        if num_mqa_tokens > 0:
            ...
            if self.impl.dcp_world_size > 1:
                ...
                project_before_merge = use_persistent_w_uv
                valid_counts = None
