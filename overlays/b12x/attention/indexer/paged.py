...
_B12X_INDEXER_TWO_LEVEL_FOLD_ENABLED = (
    os.getenv("B12X_INDEXER_TWO_LEVEL_FOLD", "1").strip().lower()
...
def _validate_raw_page_lengths(
    *,
    ...
    if real_page_table.device.type == "cuda" and os.getenv(
        "B12X_VALIDATE_PAGED_INDEXER_CUDA_VALUES", "0"
    ) != "1":
        return
